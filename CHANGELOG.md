...
## [1.0.49] - 2026-07-06
### Fixed
- Tiếp tục tinh chỉnh giao diện của ứng dụng (tooltip, button, nội dung thông báo);
...
## [1.0.47] - 2026-06-02
### Fixed
- Cập nhật phần hướng dẫn Remix công cụ;
- Nút share chứa link xem trước chính xác hơn.
...
## [1.0.44.i] - 2026-05-29
### Fixed
- Cập nhật link hướng dẫn sử dụng ở giao diện.
...
- Khắc phục vấn đề các bảng bị quá hẹp gây ép tiêu đề cột.
...
- Tinh chỉnh một số giao diện nhỏ.

## [v1.0.34] - 2026-05-21
### Fixed
- Điều chỉnh nhỏ cho giao diện (căn mấy cái icon ra giữa, và để nút gạt search grounding di chuyển).
